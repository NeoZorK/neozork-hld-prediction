...
class DependencyTestAnalyzer:
    ...
    def detect_environment(self) -> TestEnvironmentType:
        """Detect the current test environment"""
        if os.path.exists('/.dockerenv'):
            return TestEnvironmentType.DOCKER
        elif os.path.exists('/.container'):
            return TestEnvironmentType.CONTAINER
        else:
            return TestEnvironmentType.NATIVE
    ...
    def install_dependencies(self, environment: TestEnvironmentType) -> bool:
    ...
    def run_pytest(self, environment: TestEnvironmentType) -> Tuple[int, str, str]:
    ...
    def run_mcp_test(self, environment: TestEnvironmentType) -> Tuple[int, str, str]:
    ...
    def test_package(self, package_name: str, environment: TestEnvironmentType, test_type: TestTypeEnum) -> DependencyTestResult:
    ...
    def run_analysis(self, environment: TestEnvironmentType = None, test_type: TestTypeEnum = TestTypeEnum.ALL, 
...
def main():
    ...
    if args.environment:
        environment = TestEnvironmentType(args.environment)
    else:
        environment = None  # Will be auto-detected
    
    # Determine test type
    test_type = TestTypeEnum(args.test_type)
