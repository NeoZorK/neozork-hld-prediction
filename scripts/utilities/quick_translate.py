...
TRANSLATIONS = OrderedDict([
    ...
    (r'Services', 'Services'),
    (r'check installation', 'check installation'),
    ...
    (r'installation пакета', 'package installation'),
    (r'check', 'check'),
    (r'check installation', 'installation check'),
    (r'clean', 'clean'),
    (r'cache', 'cache'),
    ...
    (r'Контейнеры not launchаются', 'Containers do not start'),
    (r'Rebuild containers', 'Rebuild containers'),
    (r'Переlaunch Docker', 'Restart Docker'),
    ...
    (r'launch основного анализа', 'Launch main Analysis'),
