...
r'Conflicts dependencies': 'Dependency Conflicts',
r'Issues with productivity': 'Performance Issues',
...
r'solution \d+ Major tasks': Lambda m: f'Solves {m.group(1)}main tasks',
