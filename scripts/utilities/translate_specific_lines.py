...
TRANSLATIONS = OrderedDict([
 ...
 (r'architecture\s+([a-z][a-zA-Z\s]+)', r'architecture \1'),
(r'comparison\s+(a-a-a-a-a-s)+, r'comparison \1'),
(r'comparison\s+(a-a-a-a-a-s)+, r'comparison \1'),
(r'methods\s+(a-A-Y-Y-S)+, r'Methods \1'),
(r'methods\s+(a-A-Y-Y-S)+, r'methods \1'),
(r'workflow\s+process\s+(a-A-Y-S)+, r'Workflow \1'),
(r'workflow\s+process\s+(a-A-Y-S)+, r'workflow \1'),
(r'metrics /s+(a-A-Y-S)+, r'Metrics \1'),
(r'metrics /s+(a-A-Y-S)+, r'metrics \1'),
...
(r'\b', 'clean'),
(r'\bkash 'b', 'cause'),
(r'\b reset 'b', 'reinstall'),
(r'\b', 'performance'),
(r'\b', 'performance'),
(r'\b' architecture, 'architecture'),
(r'\barchy 'b', 'architecture'),
(r'\bcomparison, 'comparison'),
(r'\b Comparison 'b', 'Comparison'),
(r'\bmetodes\b', 'methods'),
(r'\bMethods\b', 'Methods'),
(r'\bprocess 'b', 'process'),
(r'\bProcess 'b', 'Process'),
(r'\b', 'workflow'),
(r'\b Worker 'b', 'Workflow'),
(r'\bmetrics 'b', 'metrics'),
(r'\bMetrics 'b', 'Metrics'),
(r'``b', 'validation'),
(r'``b', 'validation'),
(r'\bValidation ', 'Validation'),
(r'\b re-learning 'b', 'retraining'),
(r'\b-retraining, 'retraining'),
(r'\b Retraining, 'Retraining'),
