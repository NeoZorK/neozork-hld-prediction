...
"""
Cursor IDE MCP Server for Neozork HLD Prediction Project
Enhanced MCP server optimized for Cursor IDE with financial data integration
"""
...
class CursorMCPServer:
    ...
    def __init__(self, project_root: Path = None):
        ...
        print_to_stderr("🚀 Starting Cursor IDE MCP Server...")
        ...
        self.handlers = {
            ...
            "cursor/suggestions": self._handle_suggestions,
            "cursor/context": self._handle_context
        }
        ...
        self.logger.info("Cursor IDE MCP Server initialized successfully")
        print_to_stderr("✅ Cursor IDE MCP Server initialized successfully")
    ...
    def _save_state(self):
        ...
        try:
            ...
            state_file = self.project_root / "logs" / "cursor_mcp_state.json"
    ...
    def _handle_hover(self, request_id: Any, params: Dict) -> Dict:
        ...
        return {
            "contents": {
                "kind": "markdown",
                "value": "**Cursor MCP Server**\n\nEnhanced MCP server for financial data analysis"
            }
        }
