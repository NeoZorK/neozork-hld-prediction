...
- **Временная последовательность**: data должны оставаться in хронологическом порядке
...
- **Особенности временной валидации**:
 - **Сохранение порядка**: data остаются in хронологическом порядке
...
**🔧 Детальное description параметров Analysis результатов валидации:**
...
- **parameters**:
 ...
 - **Тип**: List
 - **description**: List результатов валидации
