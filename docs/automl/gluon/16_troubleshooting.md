...
*Рисунок 1: Блок-схема решения проблем AutoML Gluon*
...
<img src="images/optimized/installation_flowchart.png" alt="Проблемы установки" style="max-width: 100%; height: auto; display: block; margin: 20px auto;">
*Рисунок 2: Диагностика и решение проблем установки AutoML Gluon*
...
<img src="images/optimized/performance_comparison.png" alt="Проблемы обучения" style="max-width: 100%; height: auto; display: block; margin: 20px auto;">
*Рисунок 3: Диагностика и решение проблем обучения AutoML Gluon*
...
<img src="images/optimized/metrics_detailed.png" alt="Проблемы производительности" style="max-width: 100%; height: auto; display: block; margin: 20px auto;">
*Рисунок 4: Диагностика и решение проблем производительности AutoML Gluon*
...
<img src="images/optimized/production_architecture.png" alt="Проблемы продакшена" style="max-width: 100%; height: auto; display: block; margin: 20px auto;">
*Рисунок 5: Диагностика и решение проблем продакшена AutoML Gluon*
...
<img src="images/optimized/advanced_production_flow.png" alt="Инструменты диагностики" style="max-width: 100%; height: auto; display: block; margin: 20px auto;">
*Рисунок 6: Полезные инструменты диагностики и мониторинга AutoML Gluon*
