...
### 🔗 Внешние интеграции Monitoringа
...
## Сводная таблица параметров Monitoringа
...
- Use простую конфигурацию дашборда
...
- Use расширенную конфигурацию дашборда with дополнительными виджетами
...
- Use внешние системы Monitoringа (Prometheus, Grafana)
