...
*Рисунок 1: Архитектура AutoML Gluon with основными компонентами*
...
- **Когда использовать**:
 ...
 - **Большие данные**: Когда данных достаточно for holdout
...
- **Что означает**: Список callback функций for Monitoringа обучения
...
**Почему список словарей?** Потому что AutoML Gluon будет тестировать каждый вариант and выберет лучший.
