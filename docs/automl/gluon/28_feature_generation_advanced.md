...
def create_rolling_features(df, target_col, windows=[3, 7, 14, 30],
 ...
 on (str): Колонка for группировки on времени
...
### 1. Интеграция with AutoML Gluon
...
## Мониторинг and валидация признаков
...
- Настройте мониторинг and валидацию признаков
...
2. **Доменные знания** - используйте экспертизу in предметной области
