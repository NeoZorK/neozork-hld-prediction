...
**Почему 80% пользователей AutoML not понимают, что происходит под капотом?** Потому что они используют AutoML как "черный ящик", not понимая принципов его работы. Это как вождение автомобиля без понимания, как работает двигатель.

### Проблемы без понимания теории
- **Слепое использование**: not понимают, почему модель работает or not работает
...
- **Независимость**: Могут решать проблемы and адаптировать систему
...
*Рисунок 15.1: Теоретические основы автоматизированного машинного обучения - основные компоненты and принципы работы*
...
**Почему NAS - это революция in дизайне нейросетей?** Потому что он автоматически находит архитектуры, которые превосходят созданные человеком, экономя месяцы работы экспертов.
...
- **Huber Loss**: Робастная function for выбросов
 ...
 - Применение: данные with выбросами
...
- **RMSprop**: Хорош for рекуррентных сетей
...
*Рисунок 15.8: Оптимизация производительности - память, вычисления, данные and модели*
...
- **`uint8`**: Беззнаковые 8-битные (0-255)
 - Экономия: 8x on сравнению with int64
