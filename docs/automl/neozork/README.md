...
8. **Полная система заработка 100%+ in месяц**
 ...
 - [18_README.md](18_README.md) - Полная documentation on Launchу and использованию системы
...
Теперь создадим нашу первую робастную ML-систему. Concept робастности in машинном обучении означает, что модель должна работать стабильно in различных рыночных условиях and not терять производительность при изменении данных.
...
**Goal:** integration машинного обучения in существующие торговые стратегии
...
- Системы Monitoringа and логирования
