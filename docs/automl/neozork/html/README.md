...
Это HTML версия документации Neozork AutoML, созданная with помощью автоматического конвертера Markdown in HTML. documentation содержит полное guide on созданию робастных ML-систем with использованием AutoML технологий.

## Структура документации

### 📁 Файлы
- **index.html** - Главная страница with содержанием and ссылками on все разделы
...
### 🌐 Просмотр in браузере
1. Откройте `index.html` in любом современном браузере
2. Используйте навигацию for перехода между разделами
