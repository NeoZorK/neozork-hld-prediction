...
**Цель:** Научиться правильно подготавливать and очищать финансовые данные for ML-моделей.
...
**Теория:** Пропущенные значения (missing values) in финансовых данных могут возникать on различным причинам: технические сбои, выходные дни, праздники, or проблемы with источниками данных. Правильная обработка пропущенных значений критична for качества ML-моделей.
...
- **Искажение статистики:** Выбросы сильно влияют on среднее значение and стандартное отклонение
...
**Теория:** Статистические признаки - это математические характеристики данных, которые описывают их распределение, изменчивость and динамику. in финансовых данных статистические признаки помогают выявить рыночные условия, риски and возможности for торговли.
...
- **improve предсказаний:** Добавляют контекстную информацию for моделей
...
- **Применение:** Показывает, как прошлые значения влияют on текущие
...
def create_time_features(df):
 ...
 # Это помогает модели понять, как прошлые значения влияют on текущие
...
def validate_data_quality(df):
 ...
 включая проверку полноты, точности and консистентности.
...
def check_data_stability(df):
 ...
 включая проверку стационарности, структурных изменений and автокорреляции.
...
def prepare_trading_data(symbol, period='2y'):
 """Полная подготовка данных for торговли"""
