...
- Описаны все исправления and технические детали
- Добавлены examples использования

## 🎉 Заключение
Wave indicator теперь полностью работает in `-d fast` режиме and выглядит идентично `-d fastest` режиму. Все проблемы with отображением линий and сигналов исправлены.
