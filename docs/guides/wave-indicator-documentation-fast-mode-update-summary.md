...
## 🎯 Задача
Обновить документацию and туториалы for wave indicator with поддержкой `-d fast` режима, включая update индексов and create новых руководств.
...
Wave indicator теперь имеет полную документацию for всех режимов отображения, включая новый fast режим with прерывистыми линиями and цветовым кодированием сигналов.
