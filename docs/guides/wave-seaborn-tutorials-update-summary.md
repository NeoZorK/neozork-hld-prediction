...
- Добавлена рекомендация on тестированию всех режимов
- Добавлена рекомендация on использованию seaborn режима for профессиональных отчетов
...
### Новые документы
- [Wave Seaborn Mode](docs/guides/wave-indicator-seaborn-mode.md) - Полное guide on seaborn режиму
...
- **Профессиональных отчетов** with современной эстетикой
