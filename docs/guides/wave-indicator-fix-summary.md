...
- Улучшена обработка ошибок with показом доступных колонок
...
- check всех аспектов работы индикатора
...
- ❌ Пользователи думали, что индикатор not работает
...
- ✅ Автоматическое определение колонок сигналов for всех indicators
...
### Обработка ошибок
Если ни одна из колонок not найдена, система показывает:
...
Индикатор WAVE теперь работает корректно and показывает полный анализ торговых метрик in режиме fastest.
