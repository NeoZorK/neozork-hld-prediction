# -*- coding: utf-8 -*-
# src/plotting/fixed_term_phld_plot.py

"""
Fixed version of PHLD terminal plotting functions.
...
def safe_plot_phld_terminal(df: pd.DataFrame,
    ...
    """
    Simplified and safe PHLD terminal plot function that avoids DataFrame ambiguity.
    ...
    try:
        ...
        if has_ohlc:
            ...
            # Add indicators - safely extract values to lists
            for col in df.columns:
                ...
                try:
                    ...
                    if 'pprice' in col_lower or 'predicted' in col_lower:
                        color = "yellow+"
                        plt.plot(x_values, values, color=color, label=col, marker="D")
        ...
        logger.print_success("PHLD plot displayed successfully")

    except Exception as e:
        logger.print_error(f"Safe PHLD plot failed: {e}")
        import traceback
