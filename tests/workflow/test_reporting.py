# tests/workflow/test_reporting.py (CORRECTED - Key and Value Fixes + Assertion Key)
...
# Configure the standard logging module to suppress messages below CRITICAL during tests
# This prevents logger output from interfering with test results capture if necessary
logging.basicConfig(level=logging.CRITICAL)
# -----------------------------


# Sample results dictionary structure for testing (Unchanged)
MOCK_BASE_RESULTS = {
...
class TestReporting(unittest.TestCase):
    ...
    # Helper to extract log messages - CORRECTED V2 (Unchanged)
    ...
    # Helper to create mock args based on results (Unchanged)
    ...
    def test_print_summary_csv_success(self, mock_print_info, mock_print_error):
        ...
        # --- Assertions --- # Updated to check for key strings (Unchanged)
    ...
    def test_print_summary_failure(self, mock_print_info, mock_print_error):
        ...
        mock_results.update({
            ...
            "calc_duration": 0.0, # Explicitly add 0.0
        ...
        self.assertTrue(any("Plotting Time:" in line and "0.000 sec" in line for line in call_args_list_info), "Plotting time 0.000s missing in failure summary")
