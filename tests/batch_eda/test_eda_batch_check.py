...
from src.batch_eda import eda_batch_check
import pandas as pd
...
class TestEdaBatchCheck(unittest.TestCase):
    ...
    @patch('src.batch_eda.eda_batch_check.file_info')
    @patch('src.batch_eda.eda_batch_check.folder_stats')
    ...
    def test_script_runs(self, mock_folder_stats, mock_file_info):
        ...
        # Mock the file_info and folder_stats functions
        mock_file_info.get_file_info.return_value = {
            'file_path': '/fake/path/file1.parquet',
            'file_name': 'file1.parquet',
            'file_size_mb': 1.23,
    ...
    @patch('src.batch_eda.eda_batch_check.file_info')
    @patch('src.batch_eda.eda_batch_check.folder_stats')
    @patch('src.batch_eda.eda_batch_check.data_quality')
    ...
    @patch('src.batch_eda.eda_batch_check.file_info')
    @patch('src.batch_eda.eda_batch_check.folder_stats')
    @patch('src.batch_eda.eda_batch_check.fix_files')
    ...
    @patch('src.batch_eda.eda_batch_check.file_info')
    @patch('src.batch_eda.eda_batch_check.folder_stats')
    @patch('src.batch_eda.basic_stats.descriptive_stats')
    @patch('src.batch_eda.basic_stats.print_descriptive_stats')
