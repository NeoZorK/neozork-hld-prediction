...
class TestPlottingGenerationStep(unittest.TestCase):
    ...
    # Mocks in reverse order of decorators (bottom up)
    @patch('src.plotting.plotting_generation.logger') # Use default MagicMock
    @patch('src.plotting.plotting_generation.webbrowser.open')
    @patch('src.plotting.plotting_generation.plot_indicator_results_plotly')
    @patch('src.plotting.plotting_generation.Path')
    # Correct argument order: Path, Plotly, Webbrowser, Logger
    def test_generate_plot_success(self, mock_path_class, mock_plotly_plot, mock_webbrowser_open, mock_logger):
        # --- Configure Mocks ---
    ...
    @patch('src.plotting.plotting_generation.Path')
    # Correct argument order: Path, Plotly, Webbrowser, Logger
    def test_generate_plot_estimated_point(self, mock_path_class, mock_plotly_plot, mock_webbrowser_open, mock_logger):
        # --- Configure Mocks ---
    ...
    @patch('src.plotting.plotting_generation.plot_indicator_results_plotly')
    # Correct argument order: Plotly, Logger
    def test_generate_plot_skip_none_df(self, mock_plotly_plot, mock_logger):
    ...
    @patch('src.plotting.plotting_generation.plot_indicator_results_plotly')
    # Correct argument order: Plotly, Logger
    def test_generate_plot_skip_empty_df(self, mock_plotly_plot, mock_logger):
        # No need to configure or check Path mock here
    ...
    @patch('src.plotting.plotting_generation.plot_indicator_results_plotly')
    # Correct argument order: Plotly, Logger
    def test_generate_plot_none_rule(self, mock_plotly_plot, mock_logger):
        # No need to configure or check Path mock here
    ...
    @patch('src.plotting.plotting_generation.logger') # Use standard MagicMock
    @patch('src.plotting.plotting_generation.plot_indicator_results_plotly')
    @patch('traceback.format_exc')
    @patch('src.plotting.plotting_generation.Path')
    # Correct argument order: Path, Traceback, Plotly, Logger
    def test_generate_plot_exception_handling(self, mock_path_class, mock_traceback, mock_plotly_plot, mock_logger):
        # --- Configure Mocks ---
        mock_path_instance = MagicMock(spec=Path)
        mock_path_instance.stem = self.expected_stem
        mock_path_class.return_value = mock_path_instance
