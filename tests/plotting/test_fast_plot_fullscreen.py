#!/usr/bin/env python3
"""
Test for fast_plot_fullscreen.py module.
Tests the dynamic fullscreen height functionality for OHLCV rule in fast mode.
"""
...
from src.plotting.fast_plot_fullscreen import (
    get_screen_height,
...
class TestFastPlotFullscreen(unittest.TestCase):
    """Test cases for fast_plot_fullscreen.py module."""
    ...
    def setUp(self):
        ...
        self.output_path = "results/plots/test_fast_plot_fullscreen.html"
    ...
    def test_calculate_dynamic_height_other_rules(self):
        ...
        # Test with non-OHLCV rule
        height = calculate_dynamic_height(rule_str="RSI")
        self.assertEqual(height, 1100)  # Should return default height

    def test_calculate_dynamic_height_with_screen_height(self):
        """Test dynamic height calculation with specific screen height."""
        screen_height = 1920
        height = calculate_dynamic_height(screen_height=screen_height, rule_str="OHLCV")
        expected_height = int(screen_height * 0.85)
        self.assertEqual(height, expected_height)

    def test_plot_indicator_results_fast_fullscreen_basic(self):
