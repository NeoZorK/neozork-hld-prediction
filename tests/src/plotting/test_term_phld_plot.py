...
def test_import():
    """Test that term_phld_plot module can be imported."""
    try:
        ...
        import src.plotting.term_phld_plot
        assert src.plotting.term_phld_plot is not None
        
    except ImportError as e:
        pytest.fail(f"Failed to import term_phld_plot module: {e}")
