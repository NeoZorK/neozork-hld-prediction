    ...
    def test_debug_scripts_exist(self):
        ...
        for script_path in debug_scripts:
            ...
            if script_file.exists():
                ...
                pytest.skip(f"Debug script {script_path} not found, skipping test")
    ...
    def test_mcp_scripts_exist(self):
        ...
        for script_path in mcp_scripts:
            ...
            if script_file.exists():
                ...
                # If script doesn't exist, skip this test
                pytest.skip(f"MCP script {script_path} not found, skipping test")
    ...
    def test_analysis_scripts_exist(self):
        ...
        for script_path in analysis_scripts:
            ...
            if script_file.exists():
                ...
                # If script doesn't exist, skip this test
                pytest.skip(f"Analysis script {script_path} not found, skipping test")
    ...
    def test_utility_scripts_exist(self):
        ...
        for script_path in utility_scripts:
            ...
            if script_file.exists():
                ...
                # If script doesn't exist, skip this test
                pytest.skip(f"Utility script {script_path} not found, skipping test")
    ...
    def test_native_container_scripts_exist(self):
        ...
        for script_path in native_scripts:
            ...
            if script_file.exists():
                ...
                # If script doesn't exist, skip this test
                pytest.skip(f"Native container script {script_path} not found, skipping test")
    ...
    def test_docker_scripts_exist(self):
        ...
        for script_path in docker_scripts:
            ...
            if script_file.exists():
                ...
                # If script doesn't exist, skip this test
                pytest.skip(f"Docker script {script_path} not found, skipping test")
