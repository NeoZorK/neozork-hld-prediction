...
class TestSimpleLogger:
    ...
    def test_init(self, simple_logger):
    ...
    def test_print_info_unicode_characters(self, simple_logger, capsys):
        ...
        simple_logger.print_info("Test message with unicode: αβγδε")
        captured = capsys.readouterr()
        assert "[INFO] Test message with unicode: αβγδε" in captured.out
    
    def test_print_warning_unicode_characters(self, simple_logger, capsys):
        """Test print_warning with unicode characters."""
        simple_logger.print_warning("Test message with unicode: αβγδε")
        captured = capsys.readouterr()
        assert "[WARNING] Test message with unicode: αβγδε" in captured.out
    
    def test_print_error_unicode_characters(self, simple_logger, capsys):
        """Test print_error with unicode characters."""
        simple_logger.print_error("Test message with unicode: αβγδε")
        captured = capsys.readouterr()
        assert "[ERROR] Test message with unicode: αβγδε" in captured.out
    
    def test_print_success_unicode_characters(self, simple_logger, capsys):
        """Test print_success with unicode characters."""
        simple_logger.print_success("Test message with unicode: αβγδε")
        captured = capsys.readouterr()
        assert "[SUCCESS] Test message with unicode: αβγδε" in captured.out
    
    def test_print_debug_unicode_characters(self, simple_logger, capsys):
        """Test print_debug with unicode characters."""
        simple_logger.print_debug("Test message with unicode: αβγδε")
        captured = capsys.readouterr()
        assert "[DEBUG] Test message with unicode: αβγδε" in captured.out
