...
from src.batch_eda import file_info, folder_stats, data_quality, fix_files, basic_stats, correlation_analysis, feature_importance, stats_logger
...
"""
    ...
    if args.clean_reports:
        from src.batch_eda.html_report_generator import clean_all_reports
