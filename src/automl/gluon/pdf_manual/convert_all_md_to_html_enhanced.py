#!/usr/bin/env python3
"""
Создание полного HTML руководства с улучшенным форматированием
...
def create_complete_html_manual():
    """Создание полного HTML руководства"""
    ...
    output_file = docs_dir / "AutoML_Gluon_Complete_Manual_Enhanced.html"
    ...
    # HTML шаблон с улучшенным форматированием
...
<body>
    ...
    print(f"Файл готов для использования.")
    
    return True

if __name__ == "__main__":
    create_complete_html_manual()
