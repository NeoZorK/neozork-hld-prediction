...
def create_complete_html_manual():
    ...
    # HTML шаблон с правильным экранированием
...
<body>
    <div class="container">
        ...
        <div class="toc">
            <h3>Содержание</h3>
            <ul>
                <li><a href="#01-installation">1. Установка AutoML Gluon</a></li>
                <li><a href="#02-basic-usage">2. Базовое использование</a></li>
                <li><a href="#03-advanced-configuration">3. Продвинутая конфигурация</a></li>
                <li><a href="#04-metrics">4. Метрики и оценка качества</a></li>
                <li><a href="#05-validation">5. Валидация моделей</a></li>
                <li><a href="#06-production">6. Продакшен и деплой</a></li>
                <li><a href="#07-retraining">7. Переобучение моделей</a></li>
                <li><a href="#08-best-practices">8. Лучшие практики</a></li>
                <li><a href="#09-examples">9. Примеры использования</a></li>
                <li><a href="#10-troubleshooting">10. Troubleshooting</a></li>
                <li><a href="#11-apple-silicon-optimization">11. Оптимизация для Apple Silicon</a></li>
                <li><a href="#12-simple-production-example">12. Простой пример продакшена</a></li>
                <li><a href="#13-advanced-production-example">13. Сложный пример продакшена</a></li>
                <li><a href="#14-theory-and-fundamentals">14. Теория и основы AutoML</a></li>
                <li><a href="#15-interpretability-and-explainability">15. Интерпретируемость и объяснимость</a></li>
                <li><a href="#16-advanced-topics">16. Продвинутые темы</a></li>
                <li><a href="#17-ethics-and-responsible-ai">17. Этика и ответственный AI</a></li>
                <li><a href="#18-case-studies">18. Кейс-стади</a></li>
                <li><a href="#19-wave2-indicator-analysis">19. WAVE2 Индикатор - Полный анализ</a></li>
                <li><a href="#20-schr-levels-analysis">20. SCHR Levels - Анализ и ML-модель</a></li>
                <li><a href="#21-schr-short3-analysis">21. SCHR SHORT3 - Краткосрочная торговля</a></li>
                <li><a href="#22-super-system-ultimate">22. Супер-система: Объединение всех индикаторов</a></li>
                <li><a href="#23-reading-guide">23. Руководство по изучению учебника</a></li>
                <li><a href="#24-probability-usage-guide">24. Правильное использование вероятностей</a></li>
                <li><a href="#25-trading-bot-monitoring">25. Мониторинг торгового бота</a></li>
            </ul>
        </div>
