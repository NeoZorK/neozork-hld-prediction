...
class AutoMLGluonHTMLConverter:
 ...
 "Мониторинг торгового бота": "Отслеживание and управление ботом",
...
<head>
 ...
 <title>AutoML Gluon - Полное guide (33 главы)</title>
...
<body>
 ...
 <div class="header">
 <h1>AutoML Gluon</h1>
 <p>Полное guide on автоматизированному машинному обучению</p>
