...
def show_cli_examples_colored():
    ...
    print(f"{Fore.YELLOW}{Style.BRIGHT}2. DEMO DATA MODES{Style.RESET_ALL}")
    ...
    print(f"{Fore.YELLOW}{Style.BRIGHT}3. CSV FILE MODES{Style.RESET_ALL}")
    ...
    print(f"  {Fore.GREEN}CSV with PV rule, fastest backend:{Style.RESET_ALL}     python run_analysis.py csv --csv-file data.csv --point 0.01 --rule PV --draw fastest")
    print(f"  {Fore.GREEN}CSV with PV rule, seaborn backend:{Style.RESET_ALL}     python run_analysis.py csv --csv-file data.csv --point 0.01 --rule PV --draw seaborn")
    ...
    print(f"{Fore.YELLOW}{Style.BRIGHT}4. YAHOO FINANCE (YF) MODES{Style.RESET_ALL}")
    ...
    print(f"{Fore.YELLOW}{Style.BRIGHT}5. POLYGON.IO MODES{Style.RESET_ALL}")
    ...
    print(f"{Fore.YELLOW}{Style.BRIGHT}6. BINANCE MODES{Style.RESET_ALL}")
    ...
    print(f"{Fore.YELLOW}{Style.BRIGHT}7. EXCHANGE RATE API MODES{Style.RESET_ALL}")
    ...
    print(f"{Fore.YELLOW}{Style.BRIGHT}8. SHOW MODE (CACHE/FILES){Style.RESET_ALL}")
    ...
    print(f"{Fore.YELLOW}{Style.BRIGHT}9. EXPORT EXAMPLES{Style.RESET_ALL}")
    ...
    print(f"{Fore.YELLOW}{Style.BRIGHT}10. OHLCV & AUTO RULE EXAMPLES{Style.RESET_ALL}")
    ...
    print(f"{Fore.YELLOW}{Style.BRIGHT}11. INTERACTIVE MODE EXAMPLES{Style.RESET_ALL}")
    ...
    print(f"  {Fore.GREEN}Interactive mode with specific mode:{Style.RESET_ALL}    python run_analysis.py interactive")
    print()

    print(f"{Fore.YELLOW}{Style.BRIGHT}12. TROUBLESHOOTING & DIAGNOSTICS{Style.RESET_ALL}")
    ...
    print(f"{Fore.CYAN}- Use -d/--draw to select plotting backend: fastest, fast, plotly, mplfinance, seaborn, sb, term, etc.")
    ...
    print(f"2. {Fore.GREEN}Try interactive mode:{Style.RESET_ALL}                 python run_analysis.py interactive")
    print(f"3. {Fore.GREEN}Run with demo data:{Style.RESET_ALL}                   python run_analysis.py demo --rule RSI")
    print(f"4. {Fore.GREEN}Download real data:{Style.RESET_ALL}                   python run_analysis.py yfinance --ticker AAPL --period 1mo --point 0.01")
    print(f"5. {Fore.GREEN}Analyze downloaded data:{Style.RESET_ALL}              python run_analysis.py show yfinance AAPL --rule RSI")
    print(f"6. {Fore.GREEN}Export results:{Style.RESET_ALL}                       python run_analysis.py show yfinance AAPL --rule RSI --export-parquet --export-csv")
    print()
