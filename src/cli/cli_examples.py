...
def show_cli_examples_colored():
    ...
    print(f"{Fore.BLACK}{Style.DIM}# Paid Plan - Historical data with date range{Style.RESET_ALL}")
    ...
    print(f"{Fore.BLACK}{Style.DIM}# Paid Plan - Historical data with PV rule, plotly backend{Style.RESET_ALL}")
    ...
    print(f"{Style.BRIGHT}7. EXPORT OPTIONS (NEW FEATURE){Style.RESET_ALL}")
    print(f"{Fore.BLACK}{Style.DIM}# Calculate PV indicator and export to parquet{Style.RESET_ALL}")
    print(f"{Fore.GREEN}{Style.BRIGHT}python run_analysis.py yf -t EURUSD=X --period 1mo --point 0.00001 --rule PV --export-parquet{Style.RESET_ALL}")
    print(f"{Fore.BLACK}{Style.DIM}# Calculate SR indicator and export to CSV{Style.RESET_ALL}")
    print(f"{Fore.GREEN}{Style.BRIGHT}python run_analysis.py csv --csv-file data.csv --point 0.01 --rule SR --export-csv{Style.RESET_ALL}")
    print(f"{Fore.BLACK}{Style.DIM}# Calculate PHLD indicator and export to JSON{Style.RESET_ALL}")
    print(f"{Fore.GREEN}{Style.BRIGHT}python run_analysis.py binance -t BTCUSDT --interval H1 --start 2024-01-01 --end 2024-02-01 --point 0.01 --rule PHLD --export-json{Style.RESET_ALL}")
    print(f"{Fore.BLACK}{Style.DIM}# Export to all formats{Style.RESET_ALL}")
    print(f"{Fore.GREEN}{Style.BRIGHT}python run_analysis.py polygon -t AAPL --interval D1 --start 2024-01-01 --end 2024-02-01 --point 0.01 --rule PV --export-parquet --export-csv --export-json{Style.RESET_ALL}")
    print(f"{Fore.BLACK}{Style.DIM}# Show indicator files{Style.RESET_ALL}")
    ...
    print(f"{Fore.BLACK}{Style.DIM}# Show single parquet file with chart{Style.RESET_ALL}")
    print(f"{Fore.GREEN}{Style.BRIGHT}python run_analysis.py show ind parquet mn1{Style.RESET_ALL}\n")

    print(f"{Style.BRIGHT}8. SHOW MODE (CACHE/FILES){Style.RESET_ALL}")
