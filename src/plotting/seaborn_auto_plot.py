...
def auto_plot_from_parquet(parquet_path: str, plot_title: str = "Auto Plot from Parquet"):
    ...
    # Save plot to file
    plot_file = os.path.join(plots_dir, f'seaborn_plot_{os.path.basename(parquet_path).replace(".parquet", "")}.png')
    ...
    smart_plot_display(block=True, plot_type="seaborn")  # Keep plot open and block execution
