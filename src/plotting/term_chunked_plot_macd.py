# -*- coding: utf-8 -*-
# src/plotting/term_chunked_plot_macd.py

"""
plot_macd_chunks function for terminal chunked plotting.
"""
    ...
    try:
        ...
        if Use_Navigation:
            ...
            def plot_chunk_with_Navigation(
                ...
                plt.title(
                    f"{title} - OHLC Chart (Chunk {chunk_info['index']}/{chunk_info['total']}) - {chunk_info['start_date']} to {chunk_info['end_date']}")
                plt.ylabel("Price")
