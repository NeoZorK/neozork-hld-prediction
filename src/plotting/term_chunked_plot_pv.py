# -*- coding: utf-8 -*-
# src/plotting/term_chunked_plot_pv.py

"""
plot_pv_chunks function for terminal chunked plotting.
"""
    ...
    try:
        ...
        if Use_Navigation:
            ...
            def plot_chunk_with_Navigation(
                ...
                plt.title(
                    f"{title} - PV Channels with signals (Chunk {chunk_info['index']}/{chunk_info['total']}) - {start_date} to {end_date}")
        ...
        logger.print_success(
            f"Successfully displayed {len(chunks)} PV chunks with channels and signals!")
